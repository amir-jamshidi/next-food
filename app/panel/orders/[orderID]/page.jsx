        ...
        <div className="grid gap-y-1 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
          {order.mealDetails.map((meal, i) => (
            <div
              ...
              } px-4 py-6  border-l-gray-100 dark:border-l-gray-700`}
            >
              <div className="relative h-36">
                <span className="absolute text-sm bg-sky-500 z-50 inline-block rounded top-0 right-0 px-1 text-gray-100 dark:text-gray-300">
                  {meal.size}
                </span>
          ...
          <div className="border border-gray-100 bg-gray-100 dark:bg-gray-900 dark:border-gray-800 rounded-2xl py-3">
            ...
            <div className="flex flex-col items-center justify-center mt-4 bg-gray-100 dark:bg-gray-900 mx-2 gap-y-2.5 rounded-2xl py-3">
              <div className='flex gap-x-1 text-sm text-gray-700 dark:text-gray-300 '>
                <p>کد پیگیری</p>
