    ...
    <div>
      ...
      <div className="mt-12 bg-gray-800 rounded-2xl px-4 py-6 flex flex-col gap-2 text-gray-300">
        ...
        <p>
          ...
          تحویل میدهیم و از هیچ نوع مواد نگهدارنده ای استفاده نمیشود و تمامی عذا
          های موجود در سایت تازه می باشند
        </p>
        <p>
        ...
        <p>
          بسیار افتخار میکنیم که توانسته ایم تعداد بسیار زیادی مشتری جذب کنیم که
          به صورت روزانه از ما خرید میکنند و این کیفیت و اعتماد به نکستــ فــود
          را نشان میدهد
        </p>
        <p>
          در صورت هرگونه سوال یا انتقاد و پیشنهاد میتوانید به بخش مورد نظر تیکت
          بزنید یا با شماره زیر تماس برقرار کنید
        </p>
