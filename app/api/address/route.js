...
export const POST = async (req) => {
    try {
        ...
        const { fullAddress, name, reciver, phone } = await req.json();
        const address = await addressModel.create({ userID: isLoginUser._id, fullAddress, name, reciver, phone, lat: 0, lng: 0 });
