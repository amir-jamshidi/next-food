  ...
  return (
    <div className="grid grid-cols-3 gap-1 mt-8 text-sm pb-4">
      {userPanelNotifications.map((item) => (
        <div key={item.id} className={`${item.href === pathName ? 'bg-gray-300 dark:bg-gray-800' : 'dark:bg-gray-900 bg-gray-100'} flex justify-center items-center py-1.5 rounded-xl  border border-gray-300 dark:border-gray-700`}>
