    ...
    >
      ...
      <div className="flex items-center mt-5 ">
        ...
        <Link
          ...
          className="md:hover:scale-125 delay-100 w-28 border text-center hover:bg-red-500 hover:text-gray-100 transition-all hover:border-red-500 border-gray-200 dark:border-gray-600  rounded-full py-1 text-gray-700 dark:text-gray-100"
        >
          سفارش
        </Link>
